...
namespace FFmpegDotNet
{
    public class Initialize
    {
        public Initialize()
        {
            ...
            NativeLibrary.SetDllImportResolver(typeof(Initialize).Assembly, AVCodecLibraryResolver.ImportResolver);
                ...
                if (packet.stream_index == videoStreamId)
                {
                    ...
                    if (frameFinished != 0)
                    {
                        ...
                        if (frameIndex > 24 && frameIndex <= 30)
                        {
                            ...
                            SaveFrame(frameRgb, videoCodecContext.width, videoCodecContext.height, frameFileName);
                        }
                    }
                }
        ...
        private void SaveFrame(AVFrame frame, int width, int height, string fileName)
        {
